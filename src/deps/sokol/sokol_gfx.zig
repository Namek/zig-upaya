...
pub const struct_sg_image_desc = extern struct {
    ...
    d3d11_shader_resource_view: ?*const anyopaque,
...
pub const struct_sg_trace_hooks = extern struct {
    ...
    update_buffer: ?fn (sg_buffer, [*c]const sg_range, ?*anyopaque) callconv(.C) void,
    update_image: ?fn (sg_image, [*c]const sg_image_data, ?*anyopaque) callconv(.C) void,
    append_buffer: ?fn (sg_buffer, [*c]const sg_range, c_int, ?*anyopaque) callconv(.C) void,
    ...
    apply_uniforms: ?fn (sg_shader_stage, c_int, [*c]const sg_range, ?*anyopaque) callconv(.C) void,
    ...
    dealloc_buffer: ?fn (sg_buffer, ?*anyopaque) callconv(.C) void,
    dealloc_image: ?fn (sg_image, ?*anyopaque) callconv(.C) void,
    dealloc_shader: ?fn (sg_shader, ?*anyopaque) callconv(.C) void,
    dealloc_pipeline: ?fn (sg_pipeline, ?*anyopaque) callconv(.C) void,
    dealloc_pass: ?fn (sg_pass, ?*anyopaque) callconv(.C) void,
    ...
    uninit_buffer: ?fn (sg_buffer, ?*anyopaque) callconv(.C) void,
    uninit_image: ?fn (sg_image, ?*anyopaque) callconv(.C) void,
    uninit_shader: ?fn (sg_shader, ?*anyopaque) callconv(.C) void,
    uninit_pipeline: ?fn (sg_pipeline, ?*anyopaque) callconv(.C) void,
    uninit_pass: ?fn (sg_pass, ?*anyopaque) callconv(.C) void,
...
pub const struct_sg_metal_context_desc = extern struct {
    ...
    renderpass_descriptor_userdata_cb: ?fn (?*anyopaque) callconv(.C) ?*const anyopaque,
    drawable_cb: ?fn () callconv(.C) ?*const anyopaque,
    drawable_userdata_cb: ?fn (?*anyopaque) callconv(.C) ?*const anyopaque,
    user_data: ?*anyopaque,
};
...
pub const struct_sg_d3d11_context_desc = extern struct {
    ...
    render_target_view_userdata_cb: ?fn (?*anyopaque) callconv(.C) ?*const anyopaque,
    depth_stencil_view_cb: ?fn () callconv(.C) ?*const anyopaque,
    depth_stencil_view_userdata_cb: ?fn (?*anyopaque) callconv(.C) ?*const anyopaque,
    user_data: ?*anyopaque,
};
...
pub const struct_sg_wgpu_context_desc = extern struct {
    ...
    render_view_userdata_cb: ?fn (?*anyopaque) callconv(.C) ?*const anyopaque,
    resolve_view_cb: ?fn () callconv(.C) ?*const anyopaque,
    resolve_view_userdata_cb: ?fn (?*anyopaque) callconv(.C) ?*const anyopaque,
    depth_stencil_view_cb: ?fn () callconv(.C) ?*const anyopaque,
    depth_stencil_view_userdata_cb: ?fn (?*anyopaque) callconv(.C) ?*const anyopaque,
    user_data: ?*anyopaque,
};
