...
pub extern fn sapp_set_window_title(str: [*c]const u8) void;
pub extern fn sapp_set_icon(icon_desc: [*c]const sapp_icon_desc) void;
pub extern fn sapp_get_num_dropped_files() c_int;
pub extern fn sapp_get_dropped_file_path(index: c_int) [*c]const u8;
pub extern fn sapp_run(desc: [*c]const sapp_desc) void;
...
pub const SAPP_MAX_TOUCHPOINTS = @enumToInt(enum_unnamed_1.SAPP_MAX_TOUCHPOINTS);
...
pub const SAPP_MODIFIER_SHIFT = @enumToInt(enum_unnamed_2.SAPP_MODIFIER_SHIFT);
pub const SAPP_MODIFIER_CTRL = @enumToInt(enum_unnamed_2.SAPP_MODIFIER_CTRL);
pub const SAPP_MODIFIER_ALT = @enumToInt(enum_unnamed_2.SAPP_MODIFIER_ALT);
pub const SAPP_MODIFIER_SUPER = @enumToInt(enum_unnamed_2.SAPP_MODIFIER_SUPER);
pub const SAPP_MODIFIER_LMB = @enumToInt(enum_unnamed_2.SAPP_MODIFIER_LMB);
pub const SAPP_MODIFIER_RMB = @enumToInt(enum_unnamed_2.SAPP_MODIFIER_RMB);
pub const SAPP_MODIFIER_MMB = @enumToInt(enum_unnamed_2.SAPP_MODIFIER_MMB);
...
pub const struct_sapp_image_desc = extern struct {
    width: c_int,
    height: c_int,
    pixels: sapp_range,
};
pub const sapp_image_desc = struct_sapp_image_desc;
pub const struct_sapp_icon_desc = extern struct {
    sokol_default: bool,
    images: [8]sapp_image_desc,
};
pub const sapp_icon_desc = struct_sapp_icon_desc;
...
pub const SAPP_HTML5_FETCH_ERROR_NO_ERROR = @enumToInt(enum_sapp_html5_fetch_error.SAPP_HTML5_FETCH_ERROR_NO_ERROR);
pub const SAPP_HTML5_FETCH_ERROR_BUFFER_TOO_SMALL = @enumToInt(enum_sapp_html5_fetch_error.SAPP_HTML5_FETCH_ERROR_BUFFER_TOO_SMALL);
pub const SAPP_HTML5_FETCH_ERROR_OTHER = @enumToInt(enum_sapp_html5_fetch_error.SAPP_HTML5_FETCH_ERROR_OTHER);
pub const sapp_html5_fetch_error = enum_sapp_html5_fetch_error;
pub const struct_sapp_html5_fetch_response = extern struct {
    succeeded: bool,
