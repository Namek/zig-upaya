...
fn init() void {
    ...
    shader_desc.vs.source = if (builtin.target.os.tag == .macos) @embedFile("assets/shaders/vertcolor_metal.vs") else @embedFile("assets/shaders/vertcolor_gl.vs");
    shader_desc.fs.source = if (builtin.target.os.tag == .macos) @embedFile("assets/shaders/vertcolor_metal.fs") else @embedFile("assets/shaders/vertcolor_gl.fs");
